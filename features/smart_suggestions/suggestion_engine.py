...
SUGGESTION_RULES = [
    ...
    },
    {
        ...
        "description": "Arrow showing gravity direction - perfect for desk demos",
        "priority": 8,
    },
    {
        "required": ["IMU", "DISPLAY"],
        ...
        "app_name": "Orientation Cube",
        "description": "3D cube showing device orientation",
        "priority": 7,
    },
    {
        "required": ["IMU", "DISPLAY"],
        ...
        "description": "Particles that flow and respond to tilt with visual trails",
        "priority": 6,
    },
    {
        "required": ["IMU", "DISPLAY"],
        ...
        "app_name": "Spinning Gyroscope",
        "description": "Large spinning disc that responds to rotation",
        "priority": 5,
    },
    {
